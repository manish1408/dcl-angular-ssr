...
@Component({
  selector: 'app-ai-powered-product-development',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './ai-powered-product-development.component.html',
  styleUrl: './ai-powered-product-development.component.scss',
})
export class AiPoweredProductDevelopmentComponent implements AfterViewInit { 
  constructor(
    private meta: Meta,
    ...
    this.meta.addTag({ name: 'title', content: 'AI Powered Product Development - Distinct Cloud Labs' });
  }
  ...
  ngOnInit(): void {
    this.meta.updateTag({
      name: 'title',
      content: 'AI Powered Product Development Services - Distinct Cloud Labs',
    });
    this.meta.updateTag({
      name: 'description',
      content:
        'Transform your innovative ideas into market-ready products with our AI-powered product development approach. Within a budget of 10K - 50K, we launch your product in 3-4 months.',
    });
  ...
  initializeMarquee(): void {
    if (this.common.isBrowser() && typeof jQuery !== 'undefined' && jQuery.fn.marquee) {
      const marqueeElement = jQuery('app-ai-powered-product-development .marquee_text');
