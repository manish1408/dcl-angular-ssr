...
@Component({
  selector: 'app-hire-fractional-cto',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './hire-fractional-cto.component.html',
  styleUrl: './hire-fractional-cto.component.scss',
})
export class HireFractionalCtoComponent implements AfterViewInit { 
  constructor(
    private meta: Meta,
    ...
    this.meta.addTag({ name: 'title', content: 'Hire Fractional CTO - Distinct Cloud Labs' });
  }
  ...
  ngOnInit(): void {
    this.meta.updateTag({
      name: 'title',
      content: 'Hire Fractional CTO - Distinct Cloud Labs',
    });
    this.meta.updateTag({
      name: 'description',
      content: 'Tailored AI solutions for your specific needs.',
    });
  ...
  initializeMarquee(): void {
    if (this.common.isBrowser() && typeof jQuery !== 'undefined' && jQuery.fn.marquee) {
      const marqueeElement = jQuery('app-hire-fractional-cto .marquee_text');
