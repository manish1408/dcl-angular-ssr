...
@Component({
  selector: 'app-ai-customer-support',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './ai-customer-support.component.html',
  styleUrl: './ai-customer-support.component.scss',
})
export class AiCustomerSupportComponent implements AfterViewInit, OnDestroy { 
  constructor(
    private meta: Meta,
