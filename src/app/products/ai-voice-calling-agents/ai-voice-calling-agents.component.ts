...
@Component({
  selector: 'app-ai-voice-calling-agents',
  standalone: true,
  imports: [
    RouterModule,
  ...
  templateUrl: './ai-voice-calling-agents.component.html',
  styleUrl: './ai-voice-calling-agents.component.scss',
})
export class AiVoiceCallingAgentsComponent implements AfterViewInit { 
  constructor(
    private meta: Meta,
