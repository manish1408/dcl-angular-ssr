...
@Component({
  selector: 'app-ai-in-commerce',
  standalone: true,
  templateUrl: './ai-in-commerce.component.html',
  styleUrl: './ai-in-commerce.component.scss',
  imports: [
...
export class AiInCommerceComponent implements OnInit {
  constructor(
    private meta: Meta,
